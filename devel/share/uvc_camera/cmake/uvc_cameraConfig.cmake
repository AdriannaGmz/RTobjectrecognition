...
if("TRUE" STREQUAL "TRUE")
  set(uvc_camera_SOURCE_PREFIX /home/adrianna/Progr/ROS/ws/src/camera_umd/uvc_camera)
  set(uvc_camera_DEVEL_PREFIX /home/adrianna/Progr/ROS/ws/devel)
  ...
  set(uvc_camera_INSTALL_PREFIX /home/adrianna/Progr/ROS/ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ken Tossell <ken@tossell.net>, ROS Orphaned Package Maintainers <ros-orphaned-packages@googlegroups.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adrianna/Progr/ROS/ws/src/camera_umd/uvc_camera/${idir}'.  Ask the maintainer 'Ken Tossell <ken@tossell.net>, ROS Orphaned Package Maintainers <ros-orphaned-packages@googlegroups.com>' to fix it.")
    endif()
